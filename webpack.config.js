...
module.exports = (env, argv) => {
  ...
  const copyPlugin = new CopyPlugin({
    patterns: [
      ...
      {from: "./src/images/screenshots/blobble_complete_1080x1080.png", to: "./blobble_complete_1080x1080.png"},
      {from: "./src/images/screenshots/blobble_new_720x1280.png", to: "./blobble_new_720x1280.png"},
      {from: "./src/images/screenshots/blobble_new_1080x1080.png", to: "./blobble_new_1080x1080.png"},
      {from: "./src/images/screenshots/blobble_partial_720x1280.png", to: "./blobble_partial_720x1280.png"},
      {from: "./src/images/screenshots/blobble_partial_1080x1080.png", to: "./blobble_partial_1080x1080.png"},
      {from: "./src/images/screenshots/blobble_progress_720x1280.png", to: "./blobble_progress_720x1280.png"},
      {from: "./src/images/screenshots/blobble_progress_1080x1080.png", to: "./blobble_progress_1080x1080.png"},
      {from: "./src/images/screenshots/blobble_rules_720x1280.png", to: "./blobble_rules_720x1280.png"},
      {from: "./src/images/screenshots/blobble_rules_1080x1080.png", to: "./blobble_rules_1080x1080.png"},
    ],
    options: {
      concurrency: 100,
    },
